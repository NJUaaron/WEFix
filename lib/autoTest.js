...
AutoTest.waitFor = async function (timeout = 2000) {
...
AutoTest.waitUntil = async function (conFunc, timeout = 2000, interval = 10) {    // conFunc: condition function(async)
...
AutoTest.parseCookie = function (cookies) {
